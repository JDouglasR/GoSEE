...
db.Users.findOne({ email: "ana.wagner@example.com" })
...
db.Users.findOne({ email: "abigail.henry@example.com" })
...
db.Users.findOne({ email: "debra.stevens@example.com" })
...
db.Users.findOne({ email: "alfredo.howard@example.com" })
...
db.Users.findOne({ email: "richard.may@example.com" })
...
db.Users.findOne({ email: "ralph.harper@example.com" })
